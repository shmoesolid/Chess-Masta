    ...
    <div>
      ...
      <div className="row m-0">
        ...
        <div className="col-md-9">
          ...
          <hr />
          To start creating and playing games, you must first be logged into an
          account. <a href="/register">Create an account</a> or{" "}
          ...
          select 'Create Game'. Games that are password protected are meant for
          users who would like to play a game with a specific player. Set a
          password and pass it to your friend for a room that only you two can
          access.
          <br />
          <br />
